...
export class tablesForFileModule1677890346833 implements MigrationInterface {
    name = 'tablesForFileModule1677890346833'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "batches" ("id" SERIAL NOT NULL, "originalName" character varying(255) NOT NULL, "fileName" character varying(100) NOT NULL, "createdDate" TIMESTAMP DEFAULT now(), "uploaderId" integer NOT NULL, CONSTRAINT "PK_55e7ff646e969b61d37eea5be7a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "keywords" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "fileName" character varying(255), "success" boolean, "proxy" character varying(100), "error" character varying(255), "totalLinks" bigint, "totalAds" bigint, "totalResults" bigint, "searchTime" character varying(10), "createdDate" TIMESTAMP DEFAULT now(), "batchId" integer NOT NULL, CONSTRAINT "PK_4aa660a7a585ed828da68f3c28e" PRIMARY KEY ("id"))`);
