          ...
          <CCardBody>
            ...
            <DocsExample href="components/list-group/#links-and-buttons">
              <CListGroup>
                ...
                <CListGroupItem component="a" disabled>
                  Vestibulum at eros
                </CListGroupItem>
              </CListGroup>
            </DocsExample>
          ...
          <CCardBody>
            ...
            <DocsExample href="components/list-group/#flush">
              {['', '-sm', '-md', '-lg', '-xl', '-xxl'].map((breakpoint, index) => (
                <CListGroup className="mb-2" layout={`horizontal${breakpoint}` as any} key={index}>
                  <CListGroupItem>Cras justo odio</CListGroupItem>
                  <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
                  <CListGroupItem>Morbi leo risus</CListGroupItem>
                </CListGroup>
            ...
            <DocsExample href="components/list-group/#contextual-classes">
              <CListGroup>
                ...
                {[
                  ...
                  <CListGroupItem component="a" color={color} key={index}>
                    A simple {color} list group item
                  </CListGroupItem>
                ))}
              </CListGroup>
